...
> Fast transform json with simple expressions

[![PyPI version](https://badge.fury.io/py/fast-json-transform.svg)](https://pypi.org/project/fast-json-transform/)
...
```bash
pip install fast-json-transform
```
...
# Basic usage
result = transform("your input here")
print(result)
```
...
from fast_json_transform import batch
